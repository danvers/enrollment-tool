        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_required':
                    $resp[] = "Das Feld <span class=\"$field_class\">$field</span> muss ausgefüllt sein";
                    break;
                case 'validate_valid_email':
                    $resp[] = "Das Feld <span class=\"$field_class\">$field</span> muss eine gültige E-Mail-Adresse haben.";
                    break;
                ...
                case 'validate_min_len':
                    if ($param == 1) {
                        ...
                        $resp[] = "Das Feld <span class=\"$field_class\">$field</span> muss länger als $param Zeichen sein";
                    }
                    break;
