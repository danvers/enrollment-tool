...
$params = array(
    ...
    'value' => (isset($error) ? $_POST['username'] : ''),
    'type' => 'text');
...
<?php
echo Form::submit(array('name' => 'submit', 'class' => 'btn btn-primary', 'value' => \Core\Language::show('button_add', 'admin/Users')));
echo Form::close();
?>